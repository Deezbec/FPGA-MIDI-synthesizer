...
assign atan_table[30] = 32'b00000000000000000000000000000000; // atan(2^-30)
                    ...
                    // Проверить наличие
                    // рядом Тейлора - arctan(x) = x - x?/3 + x?/5 - x?/7
                    // БАМЫ          - cordic_angle = ((1 << 32)*i)/360;
                    // Возможно изменить представление внутри файла - 
                    //    начальные нули напоминают сдвиг, кол-во нулей = i + 2
                    //    конечные нули - заполнение до 64ех бит
                    //        если до 64 бит, то RF[5] не хватит